...
from app.crud.player_stats import add_or_update_player_stats, get_player_stats
...
@router.post("/player_stats", status_code=201)
async def add_player_stats_to_db(db: Session = db_dependency):
    player_stats = add_or_update_player_stats(db=db)
